...
int      raopcl_last_errno(struct raopcl_s *p);    // AirplayMultiStreamer fork: errno of the last failed connect, 0 if ok
extern int rtspcl_connect_timeout_ms;              // AirplayMultiStreamer fork: RTSP TCP connect bound (default 5000)
